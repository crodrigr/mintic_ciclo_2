...
public class Banco {
    ...
    public void calcularInteresesTodasCuentas() {
    ...
    public void consiganarCuenta(int num, double valor) {

        for (Cliente c : this.clientes) {
            for (Cuenta cuenta : c.getCuentas()) {
                if (cuenta.getNumero() == num) {
                    cuenta.consignar(valor);
                    System.out.println("Se hizo la consiganción exitosamente!");
                    break;
                }
    ...
    public void retirarCuenta(int num, double valor) {

        for (Cliente c : this.clientes) {
            for (Cuenta cuenta : c.getCuentas()) {
                if (cuenta.getNumero() == num) {
                    cuenta.retirar(valor);
                    System.out.println("Se hizo el retiro exitosamente!");
                    break;
                }
